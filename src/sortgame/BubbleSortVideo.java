 ...
 * @author ASHI
 */
public class BubbleSortVideo extends javax.swing.JFrame {

    /**
     * Creates new form BubbleSortVideo
     */
    public BubbleSortVideo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BubbleSortVideo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BubbleSortVideo().setVisible(true);
            }
        });
    }
