 ...
 * @author ASHI
 */
public class InsertionSortVideo extends javax.swing.JFrame {

    /**
     * Creates new form InsertionSortVideo
     */
    public InsertionSortVideo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsertionSortVideo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InsertionSortVideo().setVisible(true);
            }
        });
    }
